...
public class PathFinding {
	...
	JButton creditB = new JButton("Credit");
        //RADIOBUTTON
        JRadioButton dijkstraRB = new JRadioButton("Dijkstra");
        JRadioButton aStarRB = new JRadioButton("A*");
        //BUTTON GROUP
        ButtonGroup algoritmBG = new ButtonGroup();
	//DROP DOWN
	...
	private void initialize() {	//INITIALIZE THE GUI ELEMENTS
		...
		specP.setBorder(BorderFactory.createTitledBorder(loweredetched,"Controls"));
		int space = 25;
		int buff = 45;
		
		specP.setLayout(null);
		specP.setBounds(10,10,210,600);
		...
		space+=25;
                ...
                dijkstraRB.setBounds(80,space,80,25);
                aStarRB.setBounds(30,space,40,25);
                algoritmBG.add(dijkstraRB);
                algoritmBG.add(aStarRB);
                specP.add(dijkstraRB);
                specP.add(aStarRB);
		space+=40;
		...
		frame.getContentPane().add(specP);
		...
		creditB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(frame, "	                         Path Finding\n \n"
                                                                    + "                          Yash Jain\n"
                                                                    + "                      NIT Jaipur, CSE'22\n"
                                                                    + "              Build Date: February 9, 2020   ", "Credit", JOptionPane.PLAIN_MESSAGE, new ImageIcon(""));
			}
		});
	...
	class Algorithm {	//ALGORITHM CLASS
		...
		//A STAR WORKS ESSENTIALLY THE SAME AS DIJKSTRA CREATING A PRIORITY QUE AND PROPAGATING OUTWARDS UNTIL IT FINDS THE 
		//END. HOWEVER ASTAR BUILDS IN A HEURISTIC OF DISTANCE FROM ANY NODE TO THE FINISH
